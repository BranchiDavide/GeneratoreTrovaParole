...
let hintBtn = document.getElementById("changeFinalWordHint");
...
//Listener click del bottone per l'auto generazione
...
//Listener click bottone per la generazione manuale
...
async function standardGen(){
    if(!alreadyGenerated){ //Controllo per verificare se la griglia è già stata generata
        //charCounter = 142; //TMP! (solo per test!)
        //await sleep(100);
