...
genBtn.addEventListener("click", () =>{
    if(!alreadyGenerated){
        Swal.fire({
            icon: 'question',
            title: 'Tipo di generazione',
            html: `
            <button class="gen-type-btn" id="standardGenBtn">Standard</button>
            <button class="gen-type-btn" id="autoGenBtn">Automatica</button>
            `,
            showCancelButton: false,
            showConfirmButton: false,
        });
        document.getElementById("standardGenBtn").addEventListener("click", () =>{
            swal.close();
            standardGen();
        });
